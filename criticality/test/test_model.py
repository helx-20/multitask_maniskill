...
if __name__ == '__main__':
    ...
    parser.add_argument('--criticality_ckpt', type=str, default='criticality/stage1/model/stage1_criticality_best_2.pt')
    ...
    parser.add_argument('--criticality_threshold', type=float, default=0.6, help="Threshold for applying disturbance in NADE")
